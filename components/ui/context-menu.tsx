...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "glass-panel z-50 min-w-[8rem] overflow-hidden rounded-md border border-white/10 p-1 text-foreground shadow-md",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(
        "glass-panel z-50 min-w-[10rem] overflow-hidden rounded-md border border-white/10 p-1 text-foreground shadow-md",
        className,
      )}
      {...props}
    />
